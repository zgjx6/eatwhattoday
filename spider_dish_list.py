...
def analyze_dishes_with_qwen3(dishes: List[Dict]) -> List[Dict]:
  ...
  prompt_template = """
    请分析以下菜肴列表，并以严格的 JSON 格式返回结果，返回一个数组，每个元素包含字段：菜名、菜系、用时、价格、特色、味道。
...
if __name__ == "__main__":
  my_dish_list = [
    { "菜名": "番茄虾滑粉丝煲", "菜系": "", "用时": "", "价格": "", "特色": [], "味道": [], "链接": { }, "图片": "" },
    { "菜名": "番茄滑肉煲", "菜系": "", "用时": "", "价格": "", "特色": [], "味道": [], "链接": { }, "图片": "" },
    { "菜名": "酸菜滑肉", "菜系": "", "用时": "", "价格": "", "特色": [], "味道": [], "链接": { }, "图片": "" },
    { "菜名": "素炒平菇", "菜系": "", "用时": "", "价格": "", "特色": [], "味道": [], "链接": { }, "图片": "" },
    { "菜名": "醋溜白菜", "菜系": "", "用时": "", "价格": "", "特色": [], "味道": [], "链接": { }, "图片": "" },
    { "菜名": "蒜蓉蚝油娃娃菜", "菜系": "", "用时": "", "价格": "", "特色": [], "味道": [], "链接": { }, "图片": "" },
    { "菜名": "猪肉大葱肉饼", "菜系": "", "用时": "", "价格": "", "特色": [], "味道": [], "链接": { }, "图片": "" },
    { "菜名": "家常肉饼", "菜系": "", "用时": "", "价格": "", "特色": [], "味道": [], "链接": { }, "图片": "" },
  ]
